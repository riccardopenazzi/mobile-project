...
import it.unibo.noteforall.data.firebase.StorageUtil.Companion.getUserNotification
...
fun NotificationScreen() {
    ...
    LaunchedEffect(isLaunched) {
        if (!isLaunched) {
            getUserNotification(CurrentUserSingleton.currentUser!!.id, notificationList)
            isLaunched = true
        }
    }
    LazyColumn(
